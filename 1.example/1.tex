...
\author{
    \IEEEauthorblockN{Arif Suganda}
    \IEEEauthorblockA{Tadulako University}
}
...
\begin{IEEEkeywords}
Depth Estimation, Generative Adversarial Network, 3D Modeling
\end{IEEEkeywords}

\section{Introduction}
Depth estimation (DE) research in robotic~\cite{chang9010976}, autonomous driving, and 3d modeling has varied in result with overall accuracy consistently high.
There are many approach explored by the current researches from optimizing hardware~\cite{chang9010976}, 
improving dataset~\cite{guizilini9156708}, and/or using new set of architecture~\cite{guizilini9156708,hendra10113647}.
...
Proposed method on research.
\section{Experiment}
Experiment details.
\section{Discussion}
Discussion about the results, and ablation study.
\section{Conclusion}
Conclusion goes here.
\section{Acknowledgments}
Aknowledgments goes here.
